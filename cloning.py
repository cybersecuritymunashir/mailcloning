...
os.system("clear")
idt = raw_input("\033[39m[\033[31m*\033[39m] Your Email   : ")
...
if 'access_token' in op:
    ...
    print ("\033[39m[\033[31m+\033[39m] Login Succes")
else:
...
print ("\033[39m[\033[31m+\033[39m] Welcome in cyber security munshir tools...")
